...
public class UserController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegDTO regDTO) {
        ...
        try {
            ...
            return ResponseEntity
                    ...
                    .body(Map.of("message", "Unable to register the user due to server error"));
        }
    ...
    @GetMapping("/me")
    public void getCurrentUser(@RequestHeader("Authorization") String token) {
        System.out.println("Logged in as: " + token);
    }
